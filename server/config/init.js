...
module.exports = function() {
    ...
    require.extensions['.server.midware.js'] = require.extensions['.js'];
    ...
    require.extensions['.server.api.js'] = require.extensions['.js'];
    require.extensions['.server.enum.js'] = require.extensions['.js'];
    require.extensions['.server.task.js'] = require.extensions['.js'];
    require.extensions['.server.support.js'] = require.extensions['.js'];
    require.extensions['.server.text.js'] = require.extensions['.js'];
